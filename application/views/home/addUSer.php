                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() ?>addNewUser" method="post" role="form">
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required digits" id="mobile" value="<?php echo set_value('mobile'); ?>" name="mobile" maxlength="15">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                <div class="form-group">
                                        <label for="refferal">Kode Refferal</label>
                                        <input type="text" placeholder="opsional" class="form-control" id="refferal" value="<?php echo $reff; ?>" name="refferal" maxlength="11">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                </div>
