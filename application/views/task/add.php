<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <i class="fa fa-user-circle-o" aria-hidden="true"></i> Content Management
            ...
            <div class="col-md-12">
              <!-- general form elements -->
                ...
                <div class="box box-primary">
                    ...
                    <form name="my_form" role="form" enctype="multipart/form-data" id="addTask" action="<?php echo base_url() ?>task/addNewTask" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">                                
